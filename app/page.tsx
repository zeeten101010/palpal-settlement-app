...
export default function Page() {
  ...
  async function loadCashItems() {
    try {
      const data = await api(`/api/cash-items?month=${month}&includeOpenScheduled=true&_=${Date.now()}`);
    ...
    <main className="container">
      ...
      {tab === "summary" && (
        <section className="card report-card">
          ...
          <div className="report-section cost-rate-section">
            <div className="report-section-head">
              <span>원가</span>
              <h3>원가율 산정표</h3>
            </div>
            ...
            <div className="report-comment light">
              손익계산은 실제 지출 기준으로 보고, 원가율은 별도로 계산합니다. 원가율 = (기초재고 + 매입 - 기말재고) ÷ 매출.
            </div>
